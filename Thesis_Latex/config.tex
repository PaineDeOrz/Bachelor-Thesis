...
\iftex4ht
  %tex4htdoes not work well with vref, therefore we emulate vref behavior
...
\setlength{\textfloatsep}{8pt plus 2pt minus 2pt} % text <-> top/bottom floats
\setlength{\intextsep}{8pt plus 2pt minus 2pt}    % text <-> [h]/[H] floats
\setlength{\floatsep}{6pt plus 2pt minus 2pt}     % space between two floats

\setlength{\abovecaptionskip}{4pt}                % figure <-> caption
\setlength{\belowcaptionskip}{2pt}                % caption <-> text
